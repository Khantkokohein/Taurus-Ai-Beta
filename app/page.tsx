        ...
        <div className="mx-auto max-w-[980px]">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <div className="text-[14px] font-semibold text-zinc-900">{personaInfo.title}</div>
              </div>
            </div>
          ...
          <div className="mt-3 rounded-2xl border border-emerald-200/50 bg-white/55 backdrop-blur-xl px-4 py-3">
            <div className="text-[12px] text-zinc-700">
              <span className="font-semibold text-zinc-900">Sign in with Google</span> to unlock enhanced security and advanced features.
              Taurus AI does not access or store your Gmail content. Your data is never sold or used for advertising.
            </div>
          </div>
        </div>
      </header>
          ...
          >
            ...
            <div className="px-4 py-3 border-b border-emerald-200/35 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-[13px] font-semibold text-zinc-900">{personaInfo.title}</span>
                <span className="text-[12px] text-zinc-500">• {personaInfo.subtitle}</span>
              </div>
              <button
                onClick={() => {
                  // End Chat button appears logically when switching; here offers quick end
        ...
        <div className="mx-auto max-w-[980px]">
          ...
          >
            <div className="flex items-end gap-2">
              {/* Photo button (Both: also in menu) */}
              <button
                onClick={photoCreate}
              ...
              <div className="flex-1">
                ...
                <div className="mt-1 flex items-center justify-between px-1">
                  <span className="text-[11px] text-zinc-500">Glass White • Green accent only</span>
          ...
          <aside className="absolute right-0 top-0 h-full w-[86%] max-w-[380px] bg-white/75 backdrop-blur-2xl border-l border-emerald-200/60 shadow-[0_0_60px_rgba(16,185,129,0.12)]">
            <div className="p-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                <GlassButton
                  onClick={() => {
                    // If they want End Chat shown before switching, keep this action clean.
                    if (messages.length > 0) {
      ...
      {tcOpen ? (
        <ModalShell title="Terms & Conditions" onClose={() => setTcOpen(false)}>
          <div className="space-y-3 text-[13px] text-zinc-700 leading-relaxed">
            ...
            <p>
              Taurus AI is a beta product. Features may change without notice. We aim to provide accurate responses, but
              outputs may contain errors. Use critical judgment for important decisions.
            </p>
            <p>
              <span className="font-semibold">Privacy:</span> We do not access or store your Gmail content. We do not sell
              personal data or use it for advertising. (Full privacy page can be added later.)
            </p>
  ...
  return (
    <div className="absolute inset-0">
      ...
      <style jsx>{`
        ...
        .s3 { top: 22%; left: 72%; animation-delay: 1.0s; opacity: 0.8; }
  ...
  return (
    <button
      ...
      className={classNames(
        ...
        subtle
          ? "border-emerald-200/55 bg-white/55 hover:bg-white/70"
          : "border-emerald-300/70 bg-white/70 hover:bg-white/90",
  ...
  return (
    <div className="py-10 text-center">
      ...
      <div className="mt-6 max-w-[560px] mx-auto text-[12px] text-zinc-600 leading-relaxed">
        Messages are bottom-anchored. Input is fixed to the very bottom with safe-area support. Green is used only as
      ...
      <div className="mt-6 flex justify-center">
        <button
          onClick={onChoice}
          className="rounded-2xl border border-emerald-300/70 bg-white/70 backdrop-blur-2xl px-5 py-3
